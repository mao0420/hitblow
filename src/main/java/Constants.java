public class Constants {
    ...
    public static final int RULE_MISS_COUNT_FORMAT = 0;
    public static final int RULE_MISS_COUNT = 5;
    public static final int NUMBER_ENTRY_MISS_COUNT_FORMAT = 0;
    public static final int NUMBER_ENTRY_MISS_COUNT_RESET = 0;
    ...
    public static final int HIT_ANSWER_NUMBER = 3;
    public static final int MISS_INPUT_ABNORMAL_END = 4;
    public static final int GAME_OVER_LIMIT = 10;
