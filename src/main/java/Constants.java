public class Constants {
    ...
    public static final String MESSAGE_DESCRIPTION_CHOOSE = "ルール説明を表示しますか？次の選択肢から数字で入力してください。\n1.ルール説明を表示\n2.ルール説明をスキップ";
    public static final String MESSAGE_START_MESSAGE = "それでは、ヒット&ブローを開始します。\n";
    public static final String ERROR_CHOOSE_ONE_OR_TWO = "1か2で入力してください。";
    public static final String ERROR_END_OF_WARNING = "入力ミスが連続した為、ゲームを終了します。\n";
    public static final String MESSAGE_INPUT_MESSAGE = "現在までの入力回数:%d回\n「3桁の数字」を「重複無し」で入力してください。\nギブアップする際は\"G\"を入力してください。\n";
    public static final String MESSAGE_CHOOSE_GIVE_UP = "ギブアップが選択されました。";
    public static final String ERROR_INPUT_THREE_DIGIT = "3桁の数字で入力してください。";
    ...
    public static final String MESSAGE_NUMBER_FIND_FAILURE = "10回目の入力までに正解の数字を見つけられませんでした。\n";
    public static final String MESSAGE_GAME_CLEAR = "ゲームクリア！\n正解の数字は%sでした！\n入力回数:%d回\n";
    public static final String MESSAGE_GAME_OVER = "ゲームオーバー！\n正解の数字は%sでした！\n";
    public static final String MESSAGE_CHOOSE_RETRY = "ゲームをリトライしますか？次の選択肢から数字で入力してください。\n1.ゲームをリトライ\n2.ゲームを終了\n";
